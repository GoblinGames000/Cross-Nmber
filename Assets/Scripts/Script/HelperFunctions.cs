...
public static class HelperFunctions
{
    ...
    } public static int Reverse(this int nmber)
    {
       if(nmber==1)
           return 0;
       return 1;
        ...
        public static string ToDateTime(this float seconds)
        {
...
public static class WaitFor
{
    ...
    public static string ToTimeString(this float minutes)
    {
     
        TimeSpan timeSpan = TimeSpan.FromSeconds(minutes);
